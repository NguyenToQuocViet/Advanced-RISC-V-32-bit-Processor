...
// Module       : EX/MEM1 Pipeline Register
// Description  : Renamed from ex_mem_pipeline (5-stage) for 7-stage pipeline.
//                EX results held here while D-Cache SRAM read launches in MEM1.
//
// Author       : NGUYEN TO QUOC VIET
// Date         : 2026-04-27
// Version      : 2.0
// Changes      : Renamed from ex_mem_pipeline for 7-stage pipeline.
// -----------------------------------------------------------------------------

module ex_mem1_pipeline
    import cpu_pkg::*;
(
    //system interface
